  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters"> <!--size="mini"-->
          ...
          <el-form-item label="设备Id">
            <el-input v-model="filters.deviceId"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table stripe :data="rows" highlight-current-row style="width: 100%;">
        ...
        <el-table-column prop="shopsId" label="店铺Id" sortable>
        </el-table-column>
...
<script>
  ...
  import API_DEVICE from '../../api/api_shops_device';
  ...
  export default {
    ...
    methods: {
      ...
      search: function () {
        ...
        API_DEVICE.findList(params).then(function (result) {
          that.loading = false;
          if (result && result.data) {
      ...
      delRow: function (index, row) {
        ...
        this.$confirm('确认删除该记录吗?', '提示', {type: 'warning'}).then(() => {
          that.loading = true;
          API_DEVICE.remove(row.id).then(function (result) {
            that.loading = false;
      ...
      editSubmit: function () {
        ...
        this.$refs.editForm.validate((valid) => {
          if (valid) {
            ...
            API_DEVICE.update(para).then(function (result) {
              that.loading = false;
              if (result && parseInt(result.errorCode) == 0) {
