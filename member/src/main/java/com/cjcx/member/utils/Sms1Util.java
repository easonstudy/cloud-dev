...
/**
 * 云片网 http://www.yunpian.com
 * 50元起充	    累计充值超过5000元	月发送量超过10万
 * 短信(元/条)	    ￥0.050	    ￥0.048	            联系客户经理
 * 语音验证码(元/次)	￥0.050	    ￥0.048
 * 视频短信(元/条)	￥0.350	    /
 */
public class Sms1Util {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        String apikey = "58a7bd2cc1bb51b4049ff60ee877b29d";

        //修改为您要发送的手机号
        String mobile = "15112754004";

        /**************** 查账户信息调用示例 *****************/
        System.out.println(Sms1Util.getUserInfo(apikey));

        /**************** 使用智能匹配模板接口发短信(推荐) *****************/
        //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
        String text = "【云片网】您的验证码是1234";
        //发短信调用示例
        System.out.println(Sms1Util.sendSms(apikey, text, mobile));
        ...
        String tpl_value = URLEncoder.encode("#code#", ENCODING) + "=" + URLEncoder.encode("1234", ENCODING)
                + "&" + URLEncoder.encode("#company#", ENCODING) + "=" + URLEncoder.encode("云片网", ENCODING);
        //模板发送的调用示例
        System.out.println(tpl_value);
        //System.out.println(Sms1Util.tplSendSms(apikey, tpl_id, tpl_value, mobile));
        ...
        //System.out.println(Sms1Util.bindCall(apikey, from ,to , duration));

        /**************** 使用接口解绑主被叫号码 *****************/
        //System.out.println(Sms1Util.unbindCall(apikey, from, to));
    }
