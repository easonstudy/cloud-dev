...
const Perfect = lazyLoading('user/perfect')
const Request = lazyLoading('user/request')
...
const baseRouter = [
  ...
  {
    path: '/user/perfect/:key',
    name: '完善资料',
    component: Perfect,
    params: {key: ''}
  },
  {
    path: '/user/request/:key',
    name: '申请测试',
    component: Request,
    params: {key: ''}
  },
...
//白名单
const whiteList = ['/login', '/user/perfect', '/user/request']
