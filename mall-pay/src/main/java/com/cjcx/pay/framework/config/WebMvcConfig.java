...
import com.cjcx.pay.framework.interceptor.AuthTokenInterceptor;
import com.cjcx.pay.framework.interceptor.CorsInterceptor;
import com.cjcx.pay.framework.interceptor.PermissionInterceptor;
import com.cjcx.pay.framework.interceptor.SessionInterceptor;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(permissionInterceptor())
                .addPathPatterns("/**")
                .excludePathPatterns("/login","/error","/index");
